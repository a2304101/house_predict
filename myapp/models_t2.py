...
class District(models.Model):
    city = models.ForeignKey(City, on_delete=models.CASCADE, verbose_name="縣市")
...
class PropertyLocation(models.Model):
    district = models.ForeignKey(District, on_delete=models.PROTECT, verbose_name="鄉鎮市區")

    full_district = models.CharField(max_length=50, null=True, blank=True, verbose_name="完整行政區")
    full_address = models.CharField(max_length=500, db_index=True,verbose_name="土地位置建物門牌")

    clean_geo = models.TextField(null=True, blank=True, verbose_name="乾淨地理位置")
    clean_address = models.TextField(null=True, blank=True, verbose_name="乾淨地址")
    unique_geo = models.TextField(null=True, blank=True, verbose_name="唯一地理位置")

    remove_no = models.CharField(max_length=150, null=True, blank=True, verbose_name="去號")
    remove_lane = models.CharField(max_length=150, null=True, blank=True, verbose_name="去弄")
    remove_alley = models.CharField(max_length=150, null=True, blank=True, verbose_name="去巷")

    final_address = models.CharField(max_length=150,null=True, blank=True, verbose_name="最後地址")
    address_used = models.FloatField(null=True, blank=True, verbose_name="用哪個地址")

    latitude = models.FloatField(null=True, blank=True, db_index=True, verbose_name="緯度")
    longitude = models.FloatField(null=True, blank=True, db_index=True, verbose_name="經度")
...
class Property(models.Model):
    ...
    location = models.ForeignKey(PropertyLocation, on_delete=models.PROTECT, verbose_name="地理位置")

    source_type = models.CharField(max_length=30, choices=SOURCE_CHOICES, db_index=True, verbose_name="資料來源")

    building_type = models.CharField(max_length=100, null=True, blank=True, verbose_name="建物型態")
    project_name = models.CharField(max_length=150, null=True, blank=True, verbose_name="建案名稱")

    area_ping = models.FloatField(null=True, blank=True, verbose_name="坪數")
    unit_price = models.FloatField(null=True, blank=True, verbose_name="單價_萬元坪")

    transfer_floor = models.CharField(max_length=100, null=True, blank=True, verbose_name="移轉層次")
    transfer_floor_clean = models.IntegerField(null=True, blank=True, verbose_name="移轉層次_清理後")

    total_floors = models.FloatField(null=True, blank=True, verbose_name="總樓層數")

    building_age = models.FloatField(null=True, blank=True, verbose_name="屋齡")
    building_age_text = models.CharField(max_length=50, null=True, blank=True, verbose_name="屋齡_temp")
    ...
    deal_year = models.IntegerField(null=True, blank=True, verbose_name="成交年")
    deal_month = models.IntegerField(null=True, blank=True, verbose_name="成交月")
    months_since_deal = models.IntegerField(null=True, blank=True, verbose_name="交易距今月數")
    time_index = models.FloatField(null=True, blank=True, verbose_name="time_index")

    elevator = models.IntegerField(null=True, blank=True, verbose_name="電梯")
    main_building_ping = models.FloatField(null=True, blank=True, verbose_name="主建物坪數")
...
class PropertyPOIFeature(models.Model):
    property = models.OneToOneField(Property, on_delete=models.CASCADE, verbose_name="房屋")
...
class House591ExistingDetail(models.Model):
    property = models.OneToOneField(Property, on_delete=models.CASCADE, db_index=True, verbose_name="房屋")

    post_id = models.BigIntegerField(unique=True, null=True, blank=True, verbose_name="post_id")
    ...
    total_price = models.BigIntegerField(null=True, blank=True, verbose_name="總價")
...
class House591PresaleDetail(models.Model):
    ...
    hid = models.FloatField(null=True, blank=True, verbose_name="hid")
